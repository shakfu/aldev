 ...
 * All language definitions have been moved to Lua files in .aldev/languages/
 *
 * Minimal C keyword arrays are kept ONLY for markdown code block highlighting.
 * For actual C file editing, the full definition loads from .aldev/languages/c.lua
 */
 ...
 * Full language definitions load dynamically from Lua (.aldev/languages/).
 ...
 *   .aldev/languages/c.lua          - C/C++ (full keyword set, all extensions)
 *   .aldev/languages/python.lua     - Python (full keyword set, all builtins)
 *   .aldev/languages/lua.lua        - Lua (full keyword set, all builtins)
 *   .aldev/languages/cython.lua     - Cython
 *   .aldev/languages/javascript.lua - JavaScript
 *   .aldev/languages/typescript.lua - TypeScript
 *   .aldev/languages/rust.lua       - Rust
 *   .aldev/languages/go.lua         - Go
 *   .aldev/languages/java.lua       - Java
 *   .aldev/languages/swift.lua      - Swift
 *   .aldev/languages/sql.lua        - SQL
 *   .aldev/languages/shell.lua      - Shell scripts
 *   .aldev/languages/markdown.lua   - Markdown
 *
 * When opening a file:
 *   1. Editor checks static HLDB for matching extension
 *   2. If found in HLDB, uses minimal static definition
 *   3. Lua module (.aldev/modules/languages.lua) can override with full definition
